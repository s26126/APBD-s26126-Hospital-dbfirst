...
namespace APBD_s26126_Hospital_dbfirst.Data;

public partial class S26126Context : DbContext
{
    public S26126Context()
    {
    }

    public S26126Context(DbContextOptions<S26126Context> options)
        : base(options)
    {
    }
